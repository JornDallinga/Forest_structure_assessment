Kim_fun <- function(Year, Data){
  ...
  urlP <- sprintf('LandsatFCC/WRS2/p%s/r%s/p%sr%s_FCC_%d', p, r, p, r, Year) #Path part of the url
  urlF <- sprintf('p%sr%s_FCC_%d_CM.tif.gz', p, r, Year) # Filename part of the url
